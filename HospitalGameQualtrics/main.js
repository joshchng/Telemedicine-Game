...
let gameState = {
    ...
    scenes: {
        ...
        patient3: {
            title: "Patient 3",
            story: "Robert complains of chest pain and shortness of breath. What is your diagnosis?",
            choices: [
                { text: "Heart Attack", next: 'patient3Correct' },
                { text: "Anxiety Attack", next: 'patient3Wrong' }
            ]
        },
        patient3Correct: {
            title: "Correct",
            story: "Robert is experiencing symptoms of a heart attack. What would you like to do next?",
            choices: [{ text: "Next patient", next: 'startBreak' }]
        },
        patient3Wrong: {
            title: "Incorrect",
            story: "Robert's symptoms are indicative of a medical emergency.",
            choices: [{ text: "Next patient", next: 'startBreak' }]
        },
		startBreak: {
			title: "Break #1",
        ...
        patient5Wrong: {
            title: "Incorrect",
            story: "Alex's symptoms are indicative of a medical emergency, but not a heart attack.",
            choices: [{ text: "Finish", next: 'endScene' }]
        },
        endScene: {
			...
			onEnter: function() {
                stopTimer();
				storeGameData(); // This will capture and store all game-related data
				document.getElementById('final-score').textContent = 'Final Score: ' + score;
				document.getElementById('telemedicine-count').textContent = 'Telemedicine Sessions: ' + telemedicineCount; // Update the count display
                document.getElementById('final-score').classList.remove('hidden');
                document.getElementById('telemedicine-count').classList.remove('hidden');
				 // Create and append the button to end the game and go to the game over screen
